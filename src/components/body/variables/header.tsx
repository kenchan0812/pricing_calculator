...
const Header = () => {
  ...
  return (
    <div className="h-[60px] py-3 px-6 flex justify-between sticky top-0 z-10 bg-muted/100 shadow-sm">
      <div className="text-lg font-bold self-center opacity-70">Variables</div>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="p-6">
          <DialogTitle className="px-8">Create a variable</DialogTitle>

          <VariableForm setOpen={setOpen} />
        </DialogContent>
      </Dialog>
    </div>
  );
